...
namespace Discover.GraphQL.Queries
{
    public class Query
    {
        ...
        public async Task<BlogPost> GetBlogPostById([Service] IBlogPostRepository blogPostRepository, [Service] ITopicEventSender eventSender, int id)
        {
            BlogPost blogPost =
